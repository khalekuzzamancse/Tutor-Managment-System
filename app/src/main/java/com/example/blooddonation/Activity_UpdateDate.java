...
public class Activity_UpdateDate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSelectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Activity_UpdateDate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
