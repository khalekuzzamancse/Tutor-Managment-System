    ...
    public void demoGetAllDocumentName() {
        ...
        firebaseCustom.getAllDocumentName("DistrictList", new CallbackDatabase() {
            ...
            public void getList(List<String> list) {
                Log.i("Fetected-AllDocumentName" + " of -> " + "DistrictList", String.valueOf(list));
            }
        });
        //fetching using lamda
        //        new DatabaseFetch().getAllDocumentName("DistrictList", list -> {
//            Log.i("Fetched-ClassList", String.valueOf(list));
//        });
    ...
    public void demoGetDocument() {
        ...
        firebaseCustom.getDocument("DistrictList", "Dhaka", new CallbackDocument() {
            @Override
            public void getDoc(HashMap<String, Object> doc) {
                Log.i("Fetected-Document" + " of -> " + "DistrictList ,Document ->" + "Dhaka", String.valueOf(doc));
            }
        });
    }
    ...
    public void demoFetDocumentField() {
        ...
        firebaseCustom.getDocumentField("UserInfo", "jahidrana190153cse@gmail.com", "Name", new
                CallBackDocumentField() {
                    @Override
                    public void getField(Object fieldValue) {
                        Log.i("Fetected-Document" + " of -> " + "DistrictList ,Document=" + "jahidrana190153cse@gmail.com ,FieldValue ->", String.valueOf(fieldValue));
                    }
                });
